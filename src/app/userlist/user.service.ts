...
export class UserService {
  ...
  UrlGroup:string="https://localhost:44342/api/Groups/"
  Url:string="https://localhost:44342/api/Users/"
  ...
  createUser(user:any): Observable<any> {  
    ...
    return this.http.post<any>(this.Url+"AddUser",  
    user, httpOptions);  
  }

  updateUser(userid,user:any): Observable<any> {  
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json'}) };  
    return this.http.put<any>(this.Url+userid,  
    user, httpOptions);  
  }

  uploadPhoto(image:FormData): Observable<any> 
  {
   return this.http.post(this.Url+"AddPhoto", image)
  ...
  {
    var result= this.http.get(this.Url+"GetUser/Id/"+id);
    return result;
  }

  getUserEmployeeById(id):Observable<any>
  {

    var result= this.http.get(this.EmployeeUrl+"GetUserEmployeeById/"+id);
    return result;
  }

  DeleteUser(userid):Observable<any>
  {
    var result= this.http.delete(this.Url+"Deleteuser/"+userid);
    return result;
  }
